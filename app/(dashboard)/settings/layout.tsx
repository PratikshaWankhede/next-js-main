...
const allSidebarNavItems = [
  ...
  { title: "SLA", href: "/settings/sla", icon: Clock, adminOnly: true as const },
  { title: "Lead Routing", href: "/settings/lead-routing", icon: Route, adminOnly: true as const },
  { title: "Tattoo Types", href: "/settings/tattoo-types", icon: List, adminOnly: true as const },
  { title: "Booking Templates", href: "/settings/booking-templates", icon: MessageCircleMore, adminOnly: true as const },
];
